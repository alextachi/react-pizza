...
import { clearCart, removeCartItem, plusCartItem, minuseCartItem } from '../redux/actions/cart';
...
function Cart() {
    ...
    const onMinuseItem = (id) => {
        dispatch(minuseCartItem(id));
    };
